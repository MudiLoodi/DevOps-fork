...
Until next week, create a CI/CD setup for your _ITU-MiniTwit_ development.
  ...
  * You can freely choose your CI/CD system.
    - If you do not have any experience with CI/CD systems, it might be easiest to adapt the example from [`Today's Exercises`](README_EXERCISE.md).
    - However, GitHub Actions have quite some drawbacks. a) they are slow, b) they cannot be executed locally in the same way as they are executed on the server, c) [GitHub becomes more and more unreliable](https://mrshu.github.io/github-statuses/), which is not practical for a CI/CD system.
    - Therefore, you might want to consult, e.g., [this list](https://github.com/ligurio/awesome-ci) to identify a suitable alternative.
  * **OBS**: Remember to log and provide good arguments for the choice of CI/CD system, i.e., why do you choose your solution instead of any other?
